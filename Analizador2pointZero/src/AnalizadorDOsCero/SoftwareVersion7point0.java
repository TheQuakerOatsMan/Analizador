	...
	*/
	private void initialize() {
		...
		*/
		...
		lex.setIcon(new ImageIcon(SoftwareVersion7point0.class.getResource("/img/play.jpeg")));
		run.add(lex);
		JMenuItem sintax = new JMenuItem("Análisis Sintactico");
		sintax.setIcon(new ImageIcon(SoftwareVersion7point0.class.getResource("/img/play.jpeg")));
		run.add(sintax);
